...
const QUIZ = {
  ...
  s2: {
    ...
    qs: [
      ...
      { q: '掉太快的警戒值是一週幾公斤？', o: ['0.5 公斤', '1 公斤', '1.5 公斤', '3 公斤'], a: 2,
        w: '一週掉超過 1.5 公斤就要回報——掉太快會流失肌肉，也會增加膽結石的機會。' },
    ],
  },
  s3: {
    ...
    qs: [
      ...
      { q: '做核心運動時要記得什麼？', o: ['憋氣用力', '越快越好', '正常呼吸不憋氣', '忍痛做完'], a: 2,
        w: '橋式、死蟲式、鳥狗式、棒式都慢慢做、正常呼吸；腰會痛就停下來回診問。' },
  ...
  s4: {
    ...
    qs: [
      { q: '瘦下來後，胖回幾公斤就要處理？', o: ['2 公斤', '5 公斤', '1 公斤', '10 公斤'], a: 0,
        w: '這條線叫「警戒線」：1 公斤內是正常波動；碰到 2 公斤就盤點聚餐、補運動、提早回診。' },
      { q: '聚餐吃多了，最晚幾小時內回正軌？', o: ['24 小時', '72 小時', '一星期', '下個月'], a: 1,
        w: '規則只有一條：72 小時內回到正常吃法，體重多半自己回落。' },
  ...
  s5: {
    ...
    qs: [
      ...
      { q: '停藥後不小心復胖了，該？', o: ['不好意思躲起來', '自己重新打針', '回診找醫師', '放棄'], a: 2,
